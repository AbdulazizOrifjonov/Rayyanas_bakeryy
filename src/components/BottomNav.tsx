...
export default function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white/70 backdrop-blur-xl border-t border-border/30 pb-safe pt-2 px-4 shadow-[0_-8px_30px_-5px_rgba(0,0,0,0.08)] z-50">
